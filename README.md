...
| 6 | [🤖 **AI-инструментарий**](#6--ai-инструментарий-и-агенты) | Конфигурации AI-агентов, промпты и специализированные навыки (MCP) |
| 7 | [🧱 **Архитектурные принципы**](#-архитектурные-принципы) | Сквозные подходы: Clean Architecture, DI, тестируемость |
| 8 | [🛠️ **Технологический стек**](#-технологический-стек) | Используемые языки, фреймворки и инструменты |
...
> 🤖 **PassOffice примечателен тем, что был реализован полностью с помощью агентского AI-программирования**: AI-агенты использовались для декомпозиции задач, проектирования решений, написания кода и последовательной доработки функциональности.
...
### 6. 🤖 [AI-инструментарий и агенты](./.github/agents/pencil.agent.md)

Проект разработан с активным использованием AI-агентов и экосистемы **Model Context Protocol (MCP)**. В репозитории сохранены конфигурации, промпты и базы знаний, которые использовались для генерации и развития кодовой базы.

- 🤖 [**Агенты**](./.github/agents) — инструкции для специализированных агентов (например, `pencil` для UI-дизайна)
- 📝 [**Промпты**](./.github/prompts) — системные промпты для Angular-разработки, написания тестов и форматирования
- 🧠 [**Навыки (Skills)**](./.agents/skills) — глубокие базы знаний по конкретным подсистемам (PassOffice) для обучения агентов предметной области
- 🔌 [**MCP**](./.github/mcp.json) — конфигурация Model Context Protocol для расширения возможностей LLM (работа с файлами, дизайном)
